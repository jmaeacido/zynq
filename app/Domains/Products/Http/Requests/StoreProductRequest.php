...
class StoreProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sku' => ['required', 'string', 'max:64', Rule::unique('products')->where('tenant_id', $this->integer('tenant_id'))],
            'barcode' => ['nullable', 'string', 'max:128', Rule::unique('products')->where('tenant_id', $this->integer('tenant_id'))],
